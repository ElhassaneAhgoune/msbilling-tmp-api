CREATE TABLE vss130_settlement_records (
                                           ...
                                           version BIGHT DEFAULT 0 NOT NULL
);

-- Create indexes
CREATE INDEX idx_vss130_settlement_date ON vss130_settlement_records(settlement_date);
CREATE INDEX idx_vss130_job_id ON vss130_settlement_records(job_id);
CREATE INDEX idx_vss130_transaction_code ON vss130_settlement_records(transaction_code);
CREATE INDEX idx_vss130_destination_id ON vss130_settlement_records(destination_id);
CREATE INDEX idx_vss130_report_id ON vss130_settlement_records(report_id_number);
CREATE INDEX idx_vss130_business_mode ON vss130_settlement_records(business_mode);
CREATE INDEX idx_vss130_source_id ON vss130_settlement_records(source_identifier);
CREATE INDEX idx_vss130_from_date ON vss130_settlement_records(from_date);
CREATE INDEX idx_vss130_to_date ON vss130_settlement_records(to_date);