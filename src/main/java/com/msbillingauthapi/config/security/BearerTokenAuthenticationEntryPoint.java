package com.msbillingauthapi.config.security;

import static com.msbillingauthapi.exception.ErrorType.UNAUTHORIZED;
import static com.msbillingauthapi.exception.ProblemDetailBuilder.forStatus;
