...
/**
 * Entity for VSS-120 Interchange Value Report data.
 * 
 * @author EL.AHGOUNE
 * @version 1.0.0
 * @since 2024
 */
@Entity
@Table(name = "vss_report_120", 
       indexes = {
           @Index(name = "idx_vss_report_120_currency", columnList = "settlement_currency"),
           @Index(name = "idx_vss_report_120_clearing", columnList = "clearing_currency"),
           @Index(name = "idx_vss_report_120_proc_date", columnList = "processing_date"),
           @Index(name = "idx_vss_report_120_file", columnList = "source_file_name")
       })
...
public class Report120Entity {
    ...
    @Size(max = 3)
    @Column(name = "clearing_currency", length = 3)
    ...
    @Column(name = "interchange_credits", precision = 15, scale = 2)
    private BigDecimal interchangeCredits;

    @Column(name = "interchange_debits", precision = 15, scale = 2)
